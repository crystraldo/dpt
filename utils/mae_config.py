...
CONFIG.train.warmup_epoch = 40
CONFIG.train.epochs = 800
CONFIG.train.start_epoch = 0
CONFIG.train.save_epoch = 3
CONFIG.train.val_epoch = 3
# clip large gradient
CONFIG.train.clip_grad = True
# resume the training (checkpoint file name)
CONFIG.train.resume_checkpoint = None
#CONFIG.train.resume_checkpoint = '/apdcephfs/share_1227775/yandali/experiment/pretrained/swin/checkpoint/latest_model.pth'
#CONFIG.train.resume_checkpoint = '/apdcephfs/share_1227775/yandali/model/cp_path/matformer/p20/checkpoints/latest_model.pth'
#CONFIG.train.resume_checkpoint = '/apdcephfs/share_1227775/yandali/model/matte_output/swin/checkpoints/latest_model.pth'
#CONFIG.train.resume_checkpoint= '/apdcephfs/share_1227775/yandali/experiment/him/matte_error/quarter_v3/checkpoints/latest_model.pth'
#CONFIG.train.resume_step = 60000
#CONFIG.train.resume_checkpoint = '/apdcephfs/share_1227775/yandali/model/cp_path/mattformerbfu/checkpoints/latest_model.pth'
